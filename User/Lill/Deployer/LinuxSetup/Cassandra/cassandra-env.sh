...
# NOTE: The Deployer will calculate these.  Comment both of these
#       out to revert to the defaults calculated above.

# MAX_HEAP_SIZE="$(maxCassandraHeapSize)"
# HEAP_NEWSIZE="$(maxCassandraNewHeapSize)"
