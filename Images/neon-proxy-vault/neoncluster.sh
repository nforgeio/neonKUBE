...
export ClusterPublicNetwork="cluster-public"

# Name of the standard cluster private overlay network.
export ClusterPrivateNetwork="cluster-private"
...
# the definitions in [Neon.Cluster.NeonClusterPorts].

#----------------------------------------------------------
# Ports [11000-11009] are reserved for cluster dashboards.

# The main NeonCluster dashboard.
export NeonClusterPorts_Dashboard=11000

# The [neon-log-kibana] (Kibana) log analysis dashboard.
export NeonClusterPorts_LogKibana=11001

#----------------------------------------------------------
# Ports [11010-11019] are reserved for cluster logging related purposes.

# The public HTTP API port exposed by for individual [neon-log-esdata#]
# Elasticsearch log repository containers.
export NeonClusterPorts_LogEsDataHttp=11010
...
export NeonClusterPorts_LogEsDataTcp=11011

# The TCP/UDP port where the [tdagent-host] service listens for log events.
export NeonClusterPorts_LogTdAgentHostForward=11012

# The HTTP port where the [tdagent-host] service listens for log events.
export NeonClusterPorts_LogTdAgentHostHttp=11013

#----------------------------------------------------------
# Ports [11020-11029] are reserved for security purposes.

export NeonClusterPorts_ProxyVault=11020

#----------------------------------------------------------
# Ports [11100-11199] are reserved for the public proxy that routes
# external traffic into the cluster.

# The public proxy port range.
export NeonClusterPorts_ProxyPublicFirst=11100
export NeonClusterPorts_ProxyPublicLast=11199

# The [neon-proxy-public] service port for routing external HTTP
# (aka Internet) requests to services within the cluster.
export NeonClusterPorts_ProxyPublicHttp=11100

# The [neon-proxy-public] service port for routing external HTTPS
# (aka Internet) requests to services within the cluster.
export NeonClusterPorts_ProxyPublicHttps=11101

#----------------------------------------------------------
# Ports [11200-11299] are reserved for the private cluster 
# proxy that routes internal traffic.

# The private proxy port range.
export NeonClusterPorts_ProxyPrivateFirst=11200
export NeonClusterPorts_ProxyPrivateLast=11299
...
export NeonClusterPorts_ProxyPrivateHttp=11200

# The [neon-proxy-private] service port for routing internal HTTPS traffic.  
# This typically used to load balance traffic to stateful services that
# can't be deployed as Docker swarm mode services.
export NeonClusterPorts_ProxyPrivateHttps=11201
