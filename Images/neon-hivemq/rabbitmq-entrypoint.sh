#!/bin/bash
#------------------------------------------------------------------------------
# FILE:         rabbitmq-entrypoint.sh
# CONTRIBUTOR:  Jeff Lill
# COPYRIGHT:    Copyright (c) 2016-2018 by neonFORGE, LLC.  All rights reserved.
#
# Modified for neonHIVE:
# 
# This is a (slightly) modified copy of the [docker-entrypoint.sh] script that
# is built into the Docker RabbitMQ base image.  I've modified it at the bottom
# to overwrite the [/etc/rabbitmq/rabbitmq.conf] generated by this script with
# the [/etc/rabbitmq/rabbitmq.neon.conf] file generated by my replacement
# Docker entrypoint script.
#
# This allows my script to fully control the configuration file, otherwise the
# original script may overwrite some of my settings.
...
#------------------------------------------------------------------------------
# neonHIVE: This is where I replace the configuration settings.
cp /etc/rabbitmq/rabbitmq.neon.conf /etc/rabbitmq/rabbitmq.conf
#------------------------------------------------------------------------------
