...
# Builds the Neon Log Collector images and pushes them to Docker Hub.
#
...
function Build
{
	...
	$registry    = GetKubeMainRegistry "neon-log-collector"
...
Build $neonKUBE_Version "4.0.1-1" -latest
