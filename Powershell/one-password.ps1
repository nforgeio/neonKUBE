...
#------------------------------------------------------------------------------
# Handles returning the user's default vault when a vault isn't specified.
#
...
function OpGetAwsCliCredentials
{
    OpEnsureSignedIn

    $env:AWS_ACCESS_KEY_ID     = OpGetPassword "NEON_OP_AWS_ACCESS_KEY_ID"
    $env:AWS_SECRET_ACCESS_KEY = OpGetPassword "NEON_OP_AWS_SECRET_ACCESS_KEY"
}
...
function OpClearAwsCliCredentials
{
