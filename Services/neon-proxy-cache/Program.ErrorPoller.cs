...
namespace NeonProxyCache
{
    public static partial class Program
    {
        ...
        /// has been unable to update the Varnish configuration and is currently running with
                ...
                new AsyncPeriodicTask(
                    ...
                    onTaskAsync:
                        async () =>
                        {
                            ...
                            {
                                log.LogError(() => $"Varnish is running with an out-of-date configuration due to a previous error at [{errorTimeUtc}] UTC.");
                            }
