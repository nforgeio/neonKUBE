...
{
    /// <summary>
    /// Manages <see cref="V1ContainerRegistryEntity"/> entities on the Kubernetes API Server.
    /// </summary>
    [EntityRbac(typeof(V1ContainerRegistryEntity), Verbs = RbacVerb.Get | RbacVerb.List | RbacVerb.Watch | RbacVerb.Update)]
    public class ContainerRegistryController : IResourceController<V1ContainerRegistryEntity>
    {
        //---------------------------------------------------------------------
        // Static members
        ...
        public async Task<ResourceControllerResult> CreatedAsync(V1ContainerRegistryEntity entity)
        {
        ...
        /// <returns>The controller result.</returns>
        public async Task<ResourceControllerResult> UpdatedAsync(V1ContainerRegistryEntity entity)
        {
        ...
        /// <summary>
        /// Called periodically when an entity has not been modified.  This can be used to implement 
        /// polling of related resources to update the entity.
        /// </summary>
        ...
        public async Task<ResourceControllerResult> NotModifiedAsync(V1ContainerRegistryEntity entity)
        {
        ...
        public async Task StatusModifiedAsync(V1ContainerRegistryEntity entity)
        {
        ...
        /// <returns>The tracking <see cref="Task"/>.</returns>
        public async Task DeletedAsync(V1ContainerRegistryEntity entity)
        {
