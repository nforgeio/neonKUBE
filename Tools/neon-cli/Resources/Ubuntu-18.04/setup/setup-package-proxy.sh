...
cat <<EOF > ${NEON_BIN_FOLDER}/package-proxy-detect
#------------------------------------------------------------------------------
# FILE:        ${NEON_BIN_FOLDER}/package-proxy-detect
...
#
#		Acquire::http::ProxyAutoDetect "\${NEON_BIN_FOLDER}/package-proxy-detect";
#
...
// [apt-cacher-ng] service at the URL specified by \${NEON_PACKAGE_PROXY}.  
// Presumably, this cache is running on the local network which can dramatically
// reduce external network traffic to the APT mirrors and improve hive setup and
// update performance.
