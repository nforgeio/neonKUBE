...
namespace NeonCli.Ansible
{
    ...
    // ---------
    //
    // Manages neonHIVE traffic director rules.
    //
    // Requirements:
    // -------------
    //
    ...
    //
    // rule         see comment                         traffic director rule details
    ...
    // ----------------
    //
    // By default, each traffic director rule change will immediatelly signal the 
    ...
    /// </summary>
    public class TrafficDirectorModule : IAnsibleModule
    {
        ...
        public void Run(ModuleContext context)
        {
            ...
            switch (name)
            {
                ...
                default:
                    ...
                    throw new ArgumentException($"[name={name}] is not a one of the valid traffic director names: [private] or [public].");
            }
            ...
            if (state != "update")
            {
                ...
                {
                    throw new ArgumentException($"[rule_name={ruleName}] is not a valid traffic director rule name.");
                }
            ...
            switch (state)
            {
                ...
                case "present":
                    ...
                    var newRule = TrafficDirectorRule.Parse(ruleText, strict: true);
                    ...
                    {
                        throw new ArgumentException($"The [rule_name={ruleName}] argument and the rule's [{nameof(TrafficDirectorRule.Name)}={newRule.Name}] property are not the same.");
                    }
                    ...
                    var validationContext = new TrafficDirectorValidationContext(name, proxySettings);
