        ...
        public void Configure(SshProxy<NodeDefinition> firstManager)
        {
            firstManager.InvokeIdempotentAction("setup/cluster-services",
                () =>
                {
                    ...
                    cluster.Docker.Secret.Set("neon-proxy-manager-credentials", NeonHelper.JsonSerialize(cluster.Vault.Client.GetAppRoleCredentialsAsync("neon-proxy-manager").Result, Formatting.Indented));
                    cluster.Docker.Secret.Set("neon-proxy-public-credentials", NeonHelper.JsonSerialize(cluster.Vault.Client.GetAppRoleCredentialsAsync("neon-proxy-public").Result, Formatting.Indented));
                    cluster.Docker.Secret.Set("neon-proxy-private-credentials", NeonHelper.JsonSerialize(cluster.Vault.Client.GetAppRoleCredentialsAsync("neon-proxy-private").Result, Formatting.Indented));
