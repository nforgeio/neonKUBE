...
namespace Neon.Net
{
    public partial class JsonClient : IDisposable
    {
        ...
        /// <summary>
        /// Performs an HTTP <b>HEAD</b> using a specific <see cref="IRetryPolicy"/> and ensuring that
        ...
        /// <summary>
        /// Performs an HTTP <b>HEAD</b> using a specific <see cref="IRetryPolicy"/> and without ensuring
