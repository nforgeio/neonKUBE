...
namespace Neon.Net
{
    public partial class JsonClient : IDisposable
    {
            ...
            return await safeRetryPolicy.InvokeAsync(
                async () =>
                {
                    ...
                    try
                    {
                        ...
                        var httpResponse = await client.OptionsAsync(requestUri, CreateContent(document), cancellationToken: cancellationToken, activity: logActivity);
        ...
        /// <summary>
        /// Performs an HTTP <b>OPTIONS</b> using a specific <see cref="IRetryPolicy"/> and ensuring that
        ...
        /// <summary>
        /// Performs an HTTP <b>OPTIONS</b> using a specific <see cref="IRetryPolicy"/> and without ensuring
