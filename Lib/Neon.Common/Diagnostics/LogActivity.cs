...
namespace Neon.Diagnostics
{
    ...
    /// don't depend on this.  For example, the NeonCluster HAProxy based services generate
    /// activity IDs based on the source and server IP address &amp; ports as well as the
    /// time and handled request count.
    /// </para>
    /// <para>
    /// In general, activity IDs are passed from service to service via the HTTP <b>X-Activity-ID</b>
    /// request header (defined by <see cref="HttpHeader"/>) and the NeonCluster HAProxy based
