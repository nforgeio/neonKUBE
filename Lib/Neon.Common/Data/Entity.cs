...
{
    /// <summary>
    /// An implementation of <see cref="IEntity"/> suitable for backing
    /// most entity implementations, including those generated by the
    /// <c>entity-gen</c> tool.
    /// </summary>
    /// <threadsafety instance="false"/>
    public abstract class Entity : NotifyPropertyChanged, IEntity
    {
        //---------------------------------------------------------------------
        // Private types
        ...
        /// don't have an explict name set in their <see cref="EntityPropertyAttribute"/>.
        /// </summary>
        ...
        /// tagged with a <see cref="EntityAttribute.Type"/> value.  This is
        ...
        /// identifiers for any inherited types to the internal <see cref="Entity.EntityTypePathName"/>
        ...
        /// using <see cref="EntityPropertyAttribute.IsTypeProperty"/>.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static TEntity Create<TEntity>(JObject jObject, IEntityContext context)
        ...
        private IEntity                     self;               // This instance cast to an [IEntity]
        private IEntity                     parent;             // The parent [IEntity] or NULL
        private IDictionary<string, string> propertyNameMap;    // Maps JSON property names to entity names
        private IEntityContext              context;            // The optional entity context
        ...
        public Entity(IDictionary<string, string> propertyNameMap, IEntityContext context = null)
        {
            Covenant.Requires<ArgumentNullException>(propertyNameMap != null);

            this.propertyNameMap = propertyNameMap;
            this.context         = context;
            this.self            = (IEntity)this;
            this.parent          = null;
        }
        ...
        public void _Attach(IEntity parent)
        {
            ...
            {
                throw new InvalidOperationException($"Cannot attach an [{nameof(IEntity)}] here when it is already attached elsewhere.");
            }
        ...
        /// one doesn't already exist (with a default value).
        /// </summary>
        /// <typeparam name="IEntity">The property value type.</typeparam>
        /// <param name="propertyMapper">The property mapper.</param>
        /// <param name="reload">Optionally specifies that the model is being reloaded.</param>
        /// <returns><c>true</c> if the mapped value changed.</returns>
        /// <remarks>
        ...
        /// </note>
        /// </remarks>
        protected bool MapProperty<IEntity>(ref EntityMapper<IEntity> propertyMapper, bool reload = false)
            where IEntity : class, Data.IEntity, new()
        {
            var jsonName  = propertyMapper.JsonName;
            var jProperty = JObject.Properties().SingleOrDefault(p => p.Name == jsonName);
            ...
            if (jProperty == null)
            {
                jProperty = new JProperty(propertyMapper.JsonName, default(IEntity));
        ...
        private void OnJsonPropertyChanged(object sender, PropertyChangedEventArgs args)
        {
            ...
            while (true)
            {
                ...
                node = (Entity)node.parent;
            }
        }

        /// <inheritdoc/>
        void IEntity._OnPropertyChanged(string propertyName)
        {
