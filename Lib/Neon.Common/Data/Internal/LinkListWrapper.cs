...
namespace Neon.Data.Internal
{
    ...
    /// </summary>
    /// <typeparam name="TEntity">The list's entity item type (implementing <see cref="IEntity"/>).</typeparam>
    /// <remarks>
    /// <note>
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        public LinkListWrapper(IEntity parentEntity, IEntityContext context, JArray jArray, IEnumerable<TEntity> items)
        {
