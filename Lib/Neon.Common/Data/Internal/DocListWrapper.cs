...
namespace Neon.Data.Internal
{
    ...
    /// </summary>
    /// <typeparam name="TDocument">The list's document item type (implementing <see cref="IDocument"/>).</typeparam>
    /// <remarks>
    /// <note>
        ...
        where TDocument : class, IDocument
    {
        ...
        public DocListWrapper(IEntity parentEntity, IEntityContext context, JArray jArray, IEnumerable<TDocument> items)
        {
