...
namespace Neon.Data.Internal
{
    ...
    /// </summary>
    /// <typeparam name="TEntity">The list item type (implementing <see cref="IEntity"/>).</typeparam>
    /// <remarks>
    /// <note>
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="parentEntity">The <see cref="IEntity"/> that owns this list.</param>
        ...
        public EntityListWrapper(IEntity parentEntity, IEntityContext context, JArray jArray, IEnumerable<TEntity> items)
        {
            ...
            else
            {
                foreach (var jToken in jArray)
                {
                    ...
                    {
                        var item = Entity.Create<TEntity>((JObject)jToken, context);
        ...
        /// <summary>
        /// Called when any of the list item's <see cref="IEntity.Changed"/> event is
