...
namespace Neon.Data.Internal
{
    ...
    /// </summary>
    /// <typeparam name="TDocument">The list element type (implementing <see cref="IDocument"/>).</typeparam>
    /// <remarks>
    /// <note>
        ...
        where TDocument : class, IDocument
    {
        ...
        public DocListMapper(IEntity parentEntity, string jsonName, string propertyName, IEntityContext context)
        {
