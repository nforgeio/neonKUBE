...
namespace Neon.Kube
{
    ...
    public class SshKey
    {
        ...
        /// <summary>
        /// The RSA public key to deployed on the server for authenticating SSH clients.
        /// This is formatted as <b>PEM</b> format as generated by the Linux <b>ssh-keygen</b>
        /// tool.
        /// </summary>
        [JsonProperty(PropertyName = "PublicPEM", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        [YamlMember(Alias = "publicPEM", ScalarStyle = ScalarStyle.Literal, ApplyNamingConventions = false)]
        [DefaultValue(null)]
        public string PublicPEM { get; set; }

        /// <summary>
        /// The RSA public key formatted as SSH2 as defined by <a href="https://tools.ietf.org/html/rfc4716">RFC 4716</a>.
        /// </summary>
