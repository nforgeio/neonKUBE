...
namespace Neon.Kube
{
    ...
    public static partial class HiveHelper
    {
        ...
        /// <b><i>hive-name</i>.json</b> holding the serialized <see cref="Kube.HiveLogin"/> 
        ...
        /// <returns>The <see cref="Kube.HiveLogin"/>.</returns>
        ...
        /// <summary>
        /// Returns the <see cref="Kube.HiveLogin"/> for the opened hive. 
        /// </summary>
        ...
        public static ClusterProxy OpenHive(HiveLogin login)
        {
            if (IsConnected)
            {
