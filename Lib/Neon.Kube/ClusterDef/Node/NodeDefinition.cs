...
namespace Neon.Kube.ClusterDef
{
    ...
    public class NodeDefinition
    {
        ...
        /// <note>
        /// <para>
        /// When all nodes have <see cref="OpenEbsStorage"/> set to <c>false</c> and <see cref="OpenEbsOptions.Mayastor"/>
        /// is set to <c>true</c>, NeonKUBE  will automatically choose the nodes that will host the Mayastor block devices
        /// by configuring up to three nodes with <b>openEbsStorage: true</b>, favoring <b>worker</b> nodes over <b>control-plane</b>
        /// nodes when possible.
        /// </para>
        /// <para>
        /// At least 3 worker or control plane-nodes are required.
        /// </para>
        /// </note>
        /// </summary>
        ...
        public string GetBootDiskSize(ClusterDefinition clusterDefinition)
        {
            ...
            switch (clusterDefinition.Hosting.Environment)
            {
                case HostingEnvironment.Aws:
                    ...
                    return Aws.BootVolumeSize ?? clusterDefinition.Hosting.Aws.DefaultBootVolumeSize;

                case HostingEnvironment.Azure:

                    return Azure.BootDiskSize ?? clusterDefinition.Hosting.Azure.DefaultBootDiskSize;
                ...
                case HostingEnvironment.XenServer:
                    ...
                    return Hypervisor.GetBootDiskSizeBytes(clusterDefinition).ToString();
