...
namespace Neon.Kube
{
    ...
    public enum OpenEbsEngine
    {
        ...
        /// select <see cref="HostPath"/> for single-node clusters or <see cref="cStor"/> for
        /// multi-node clusters.
        /// </para>
        /// <note>
        /// This logic will likely change in the future after <see cref="Jiva"/> and 
        /// <see cref="Mayastor"/> are implemented.
        /// </note>
        /// </summary>
