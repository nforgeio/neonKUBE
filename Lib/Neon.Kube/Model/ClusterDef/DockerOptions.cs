...
namespace Neon.Kube
{
    ...
    public class DockerOptions
    {
        ...
        /// so that container logs will be forwarded to the cluster logging pipeline.
        /// </summary>
        ...
        /// <summary>
        /// Controls whether the Docker Ingress network is used for for cluster proxies.  This defaults to <c>null</c>
        ...
        public bool GetAvoidIngressNetwork(ClusterDefinition clusterDefinition)
        {
