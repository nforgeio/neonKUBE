...
namespace Neon.Kube
{
    ...
    /// cluster services.  Normally, you'll want to leave these alone because the
    ...
    {
        private const string defaultRegistryCache   = ClusterConst.NeonProdRegistry + "/neon-registry-cache:latest";
        private const string defaultProxy           = ClusterConst.NeonProdRegistry + "/neon-proxy:latest";
        private const string defaultProxyVault      = ClusterConst.NeonProdRegistry + "/neon-proxy-vault:latest";
        private const string defaultProxyManager    = ClusterConst.NeonProdRegistry + "/neon-proxy-manager:latest";
        private const string defaultHiveManager     = ClusterConst.NeonProdRegistry + "/neon-hive-manager:latest";
        private const string defaultDns             = ClusterConst.NeonProdRegistry + "/neon-dns:latest";
        private const string defaultDnsMon          = ClusterConst.NeonProdRegistry + "/neon-dns-mon:latest";
        private const string defaultProxyCache      = ClusterConst.NeonProdRegistry + "/neon-proxy-cache:latest";
        private const string defaultSecretRetriever = ClusterConst.NeonProdRegistry + "/neon-secret-retriever:latest";
        private const string defaultHiveMQ          = ClusterConst.NeonProdRegistry + "/neon-hivemq:latest";
        private const string defaultLogHost         = ClusterConst.NeonProdRegistry + "/neon-log-host:latest";
        private const string defaultLogCollector    = ClusterConst.NeonProdRegistry + "/neon-log-collector:latest";
        private const string defaultElasticsearch   = ClusterConst.NeonProdRegistry + "/elasticsearch:latest";
        private const string defaultKibana          = ClusterConst.NeonProdRegistry + "/kibana:latest";
        private const string defaultMetricbeat      = ClusterConst.NeonProdRegistry + "/metricbeat:latest";
        ...
        /// on cluster pets.  This defaults to <b>nhive/neon-proxy:latest</b>.
        /// </summary>
        ...
        /// cluster log events.  This defaults to <b>nhive/elasticsearch:latest</b>.
        /// </summary>
        ...
        /// the cluster logging user interface.  This defaults to <b>nhive/kibana:latest</b>.
        /// </summary>
        ...
        /// acts as the entrypoint to the cluster's log aggregation pipeline.  This defaults to <b>nhive/neon-log-host:latest</b>.
        /// </summary>
        ...
        /// aggregator for all of the cluster nodes.  This defaults to <b>nhive/neon-log-collector:latest</b>.
        /// </summary>
