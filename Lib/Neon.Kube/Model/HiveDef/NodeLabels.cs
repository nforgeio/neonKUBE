...
namespace Neon.Kube
{
    ...
    public class NodeLabels
    {
        ...
        /// </summary>
        public const string LabelDatacenter = ClusterDefinition.ReservedLabelPrefix + ".hive.datacenter";

        /// <summary>
        /// Reserved label name that identifies the hive environment.
        /// </summary>
        public const string LabelEnvironment = ClusterDefinition.ReservedLabelPrefix + ".hive.environment";
