...
namespace Neon.Kube
{
    ...
    public class HostingManagerFactory : IHostingManagerFactory
    {
        ...
        public void Validate(ClusterDefinition clusterDefinition)
        {
            ...
            if (manager == null)
            {
                throw new KubeException($"Cannot locate a [{nameof(IHostingManager)}] implementation for the [{clusterDefinition.Hosting.Environment}] hosting environment.  This may be a premium-only feature.");
            }
