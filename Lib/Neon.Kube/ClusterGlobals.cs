...
namespace Neon.Kube
{
    ...
    public static class ClusterGlobals
    {
        ...
        /// <summary>
        /// Serialized <c>HiveMQSettings</c> for the <see cref="ClusterConst.HiveMQAppUser"/> HiveMQ account.
        /// </summary>
        ...
        /// <summary>
        /// Serialized <c>HiveMQSettings</c> for the <see cref="ClusterConst.HiveMQNeonUser"/> HiveMQ account.
        /// </summary>
