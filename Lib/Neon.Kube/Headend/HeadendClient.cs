    ...
    public sealed class HeadendClient : IDisposable
    {
        ...
        public async Task<KubeSetupInfo> GetSetupInfoAsync(ClusterDefinition clusterDefinition)
        {
            ...
            var setupInfo = new KubeSetupInfo()
            {
                ...
                HelmLinuxUri       = $"https://storage.googleapis.com/kubernetes-helm/helm-v{KubeVersions.HelmVersion}-linux-amd64.tar.gz",
                HelmOsxUri         = $"https://storage.googleapis.com/kubernetes-helm/helm-v{KubeVersions.HelmVersion}-darwin-amd64.tar.gz",
                HelmWindowsUri     = $"https://storage.googleapis.com/kubernetes-helm/helm-v{KubeVersions.HelmVersion}-windows-amd64.zip",
