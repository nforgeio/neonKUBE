...
namespace Neon.SSH
{
    ...
    /// command on a <see cref="SshLinuxProxy{T}"/>.  These options may be 
    ...
    public enum RunOptions
    {
        ...
        /// <summary>
        /// Bitwise ORs any specific option flags with those specified by <see cref="SshLinuxProxy{TMetadata}.DefaultRunOptions"/>.
        ...
        /// <summary>
        /// Puts the <see cref="SshLinuxProxy{T}"/> into the faulted state when the command
        /// returns a non-zero exit code.
        /// </summary>
        FaultOnError = 0x00000002,

        /// <summary>
        /// Runs the command even if the <see cref="SshLinuxProxy{T}"/> is in the faulted state.
        /// </summary>
        RunWhenFaulted = 0x00000004,

        /// <summary>
        /// Ignore the <see cref="SshLinuxProxy{TMetadata}.RemotePath"/> property.
        /// </summary>
