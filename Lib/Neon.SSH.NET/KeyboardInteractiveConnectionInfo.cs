...
namespace Renci.SshNet
{
    ...
    /// </summary>
    /// <example>
    ///     <code source="..\..\Lib\Neon.SSH.NET\Examples\KeyboardInteractiveConnectionInfoTest.cs" region="Example KeyboardInteractiveConnectionInfo AuthenticationPrompt" language="C#" title="Connect using interactive method" />
    /// </example>
