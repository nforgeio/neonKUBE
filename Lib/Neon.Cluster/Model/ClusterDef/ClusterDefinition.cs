...
namespace Neon.Cluster
{
    ...
    public class ClusterDefinition
    {
        ...
        private const string        defaultProxyImage          = NeonClusterConst.NeonPublicRegistry + "/neon-proxy:latest";
        private const string        defaultProxyVaultImage     = NeonClusterConst.NeonPublicRegistry + "/neon-proxy-vault:latest";
        private const string        defaultProxyManagerImage   = NeonClusterConst.NeonPublicRegistry + "/neon-proxy-manager:latest";
        private const string        defaultClusterManagerImage = NeonClusterConst.NeonPublicRegistry + "/neon-cluster-manager:latest";
        private const string        defaultDnsImage            = NeonClusterConst.NeonPublicRegistry + "/neon-dns:latest";
        private const string        defaultDnsMonImage         = NeonClusterConst.NeonPublicRegistry + "/neon-dns-mon:latest";
        ...
        /// <summary>
        /// Summarizes the current state of the cluster without including any sensitive
        /// information.  This is suitable for uploading to neonFORGE as telemetry or
        /// submitting with a GitHub issue.  This is generated by <b>neon-cluster-manager</b>
        /// to be included in the information downloaded by <b>neon-cli</b> when it
        /// executes commands.  This is ignored during cluster provisoning and setup.
        /// </summary>
        [JsonProperty(PropertyName = "Summary", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        [DefaultValue(null)]
        public ClusterSummary Summary { get; set; }
