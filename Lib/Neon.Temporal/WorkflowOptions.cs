...
namespace Neon.Temporal
{
    ...
    public class WorkflowOptions
    {
        ...
        internal static WorkflowOptions Normalize(TemporalClient client, WorkflowOptions options, Type workflowInterface = null)
        {
            ...
            if (string.IsNullOrEmpty(options.TaskList))
            {
                throw new ArgumentNullException(nameof(options), "You must specify a valid task list explicitly in [WorkflowOptions] or via an [WorkflowInterface(TaskList = \"my-tasklist\")] attribute on the target workflow interface.");
            }
        ...
        internal InternalStartWorkflowOptions ToInternal()
        {
            ...
            return new InternalStartWorkflowOptions()
            {
                ...
                DecisionTaskStartToCloseTimeout = TemporalHelper.ToTemporal(this.TaskStartToCloseTimeout.Value),
