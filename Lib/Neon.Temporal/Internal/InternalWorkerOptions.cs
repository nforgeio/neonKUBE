...
{
    /// <summary>
    /// <b>INTERNAL USE ONLY:</b> Specifies the options Temporal will use when assigning
    /// workflow and activity executions to a user's worker service.  This maps fairly 
    /// closely to the  Temporal GOLANG <b>WorkerOptions</b>, but we removed a few fields
    ...
    ///     <description>
    ///     I believe the <b>temporal-proxy</b> can a common context for all
    ///     workflow executions.
    ///     </description>
    /// </item>
    /// <item>
    ...
    ///     <description>
    ///     This is not required because <b>temporal-proxy</b> deals only with
    ///     raw byte arrays.
    ///     </description>
    /// </item>
    /// </list>
    ...
    internal class InternalWorkerOptions
    {
        ...
        [DefaultValue(5 * TemporalHelper.NanosecondsPerSecond)]
        public long StickyScheduleToStartTimeout { get; set; } = 5 * TemporalHelper.NanosecondsPerSecond;
        ...
        [DefaultValue(null)]
        public int NonDeterministicWorkflowPolicy { get; set; } = (int)Neon.Temporal.NonDeterministicPolicy.BlockWorkflow;
