//-----------------------------------------------------------------------------
// FILE:	    WorkflowDescribeExecutionRequest.cs
...
namespace Neon.Temporal.Internal
{
    ...
    internal class WorkflowDescribeExecutionRequest : WorkflowRequest
    {
        ...
        /// <summary>
        /// Optionally identifies the target namespace when <see cref="RunId"/> isn't passed.
        /// </summary>
        ...
        {
            var clone = new WorkflowDescribeExecutionRequest();
        ...
        protected override void CopyTo(ProxyMessage target)
        {
            ...
            var typedTarget = (WorkflowDescribeExecutionRequest)target;
