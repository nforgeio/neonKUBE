...
namespace Neon.Temporal.Internal
{
    ...
    /// instances into a form compatible with the Temporal GOLANG client.  This class maps
    /// to the Temporal GOLANG client structure:
    /// </para>
    /// <para>
    ...
    internal class InternalRetryPolicy
    {
        ...
        public InternalRetryPolicy(LinearRetryPolicy policy)
        {
            ...
            this.InitialInterval    = TemporalHelper.ToTemporal(policy.RetryInterval);
            this.BackoffCoefficient = 1.0;

            if (policy.Timeout.HasValue)
            {
                this.ExpirationInterval = TemporalHelper.ToTemporal(policy.Timeout.Value);
            }
        ...
        public InternalRetryPolicy(ExponentialRetryPolicy policy)
        {
            ...
            this.InitialInterval    = TemporalHelper.ToTemporal(policy.InitialRetryInterval);
            this.BackoffCoefficient = 2.0;
            this.MaximumInterval    = TemporalHelper.ToTemporal(policy.MaxRetryInterval);
        ...
        /// <summary>
        /// <para>
        /// Specifies Temporal errors that should not be retried. This is optional. Temporal server 
        /// will stop retrying if error reason matches this list.
        /// </para>
        /// <list type="bullet">
        /// <item>Custom errors: <b>temporal.NewCustomError(reason)</b></item>
        /// <item>Panic errors: <b>temporalInternal:Panic</b></item>
        /// <item>Generic errors: <b>temporalInternal:Generic</b></item>
        /// <item>
        /// Timeout errors: <b>temporalInternal:Timeout TIMEOUT_TYPE</b>, where
