...
namespace Neon.Temporal.Internal
{
    ...
    /// closely to this Temporal GOLANG structure:
    /// </para>
    /// <para>
    ...
    internal class InternalChildWorkflowOptions
    {
        ...
        [DefaultValue(10 * TemporalHelper.NanosecondsPerSecond)]
        public long TaskStartToCloseTimeout { get; set; } = 10 * TemporalHelper.NanosecondsPerSecond;
        ...
        [DefaultValue((int)Temporal.ParentClosePolicy.RequestCancel)]
        public int ChildClosePolicy { get; set; } = (int)Temporal.ParentClosePolicy.RequestCancel;
