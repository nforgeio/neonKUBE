...
namespace Couchbase.Lite
{
    ...
    /// a <see cref="EntityAttribute.Type"/>).  <see cref="Timestamp"/> can be used to indicate the
    ...
    /// and whose defining interfaces were tagged with a non-null or empty <see cref="EntityAttribute.Type"/>
    ...
    /// </para>
    /// <para>
    /// This class implements <see cref="IEntityContext"/> which enables the linking of entities that
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        /// <see cref="EntityDatabase.Register(Func{Document, IEntityDocument}, Func{IDictionary{string, object}, EntityDatabase, Revision, IEntityDocument}, string[])"/>.
        /// </exception>
        internal static IDocument Create(Type documentType, Document document)
        {
            ...
            return (IDocument)derivedDocument;
        }
        ...
        internal EntityDocument(Stub.Value stub, IDictionary<string, object> properties, EntityDatabase database, Revision revision = null)
        {
            ...
            Content = Entity.Create<TEntity>(jObject, database);
