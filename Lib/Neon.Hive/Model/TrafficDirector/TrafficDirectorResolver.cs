//-----------------------------------------------------------------------------
// FILE:	    TrafficDirectorResolver.cs
...
{
    /// <summary>
    /// Describes a traffic director DNS resolver.
    /// </summary>
    public class TrafficDirectorResolver
    {
        /// <summary>
        ...
        public List<TrafficDirectorNameserver> NameServers { get; set; } = new List<TrafficDirectorNameserver>();
