//-----------------------------------------------------------------------------
// FILE:	    TrafficDirectorNameserver.cs
...
{
    /// <summary>
    /// Describes a traffic director DNS resolver nameserver.
    /// </summary>
    public class TrafficDirectorNameserver
    {
        /// <summary>
        ...
        public void Validate(TrafficDirectorValidationContext context)
        {
            ...
            if (!string.IsNullOrWhiteSpace(Endpoint))
            {
                ...
                if (!isValid)
                {
                    context.Error($"[{nameof(TrafficDirectorNameserver)}.{nameof(Name)}={Endpoint}] is not valid.");
                }
            }
        }
    }
