//-----------------------------------------------------------------------------
// FILE:	    TrafficDirectorTcpFrontend.cs
...
{
    /// <summary>
    /// Describes a TCP traffic director frontend.
    /// </summary>
    public class TrafficDirectorTcpFrontend
    {
        /// <summary>
        ...
        public void Validate(TrafficDirectorValidationContext context, TrafficDirectorTcpRule rule)
        {
            ...
            {
                context.Error($"Rule [{rule.Name}] assigns [{nameof(ProxyPort)}={ProxyPort}] which is outside the range of valid frontend TCP ports for this traffic director [{context.Settings.ProxyPorts}].");
            }
        }
    }
}
