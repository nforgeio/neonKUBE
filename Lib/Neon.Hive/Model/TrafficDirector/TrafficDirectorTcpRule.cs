//-----------------------------------------------------------------------------
// FILE:	    TrafficDirectorTcpRule.cs
...
namespace Neon.Hive
{
    ...
    /// to TCP backends.
    /// </summary>
    public class TrafficDirectorTcpRule : TrafficDirectorRule
    {
        private List<TrafficDirectorTcpBackend> selectedBackends;     // Used to cache selected backends

        /// <summary>
        /// Default constructor.
        /// </summary>
        public TrafficDirectorTcpRule()
        {
            base.Mode = TrafficDirectorMode.Tcp;
        }
        ...
        public List<TrafficDirectorTcpFrontend> Frontends { get; set; } = new List<TrafficDirectorTcpFrontend>();

        /// <summary>
        /// The traffic director backend definitions.
        /// </summary>
        [JsonProperty(PropertyName = "Backends", Required = Required.Always)]
        public List<TrafficDirectorTcpBackend> Backends { get; set; } = new List<TrafficDirectorTcpBackend>();
        ...
        /// to the overall pool of connections specified by <see cref="TrafficDirectorSettings.MaxConnections"/>.
        ...
        public override void Validate(TrafficDirectorValidationContext context)
        {
            ...
            Frontends = Frontends ?? new List<TrafficDirectorTcpFrontend>();
            Backends  = Backends ?? new List<TrafficDirectorTcpBackend>();
        ...
        /// </note>
        /// </remarks>
        public List<TrafficDirectorTcpBackend> SelectBackends(Dictionary<string, List<NodeDefinition>> hostGroups)
        {
            ...
            selectedBackends = new List<TrafficDirectorTcpBackend>();
