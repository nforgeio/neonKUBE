...
{
    /// <summary>
    /// Holds global traffic director definition state that may be 
    /// accessed while validating a tree of traffic director settings
    /// and rules.
    /// </summary>
    public class TrafficDirectorValidationContext
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="trafficDirectorName">The traffic director name.</param>
        /// <param name="settings">The traffic director settings.</param>
        /// <param name="certificates">The optional certificates as name/value tuples.</param>
        public TrafficDirectorValidationContext(string trafficDirectorName, TrafficDirectorSettings settings, Dictionary<string, TlsCertificate> certificates = null)
        {
        ...
        /// </summary>
        public TrafficDirectorSettings Settings { get; private set; }
