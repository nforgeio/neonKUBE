...
namespace Neon.Hive
{
    ...
    public class ClusterDefinition
    {
        ...
        private const string        defaultClusterManagerImage = HiveConst.NeonPublicRegistry + "/neon-cluster-manager:latest";
        ...
        /// <summary>
        /// <para>
        /// Enables cluster debug mode which can be useful for neonHIVE development purposes.
