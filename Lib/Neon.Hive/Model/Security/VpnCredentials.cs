...
namespace Neon.Hive
{
    ...
    public class VpnCredentials
    {
        ...
        /// in the cluster Vault.  Operators that have this key will be able
        ...
        /// the time when the archive was generated by the <b>neon prepare cluster</b>
        /// command until it can be persisted to the cluster's Vault by <b>neon cluster setup</b>.
        /// </summary>
