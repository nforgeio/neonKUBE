...
namespace Neon.Web
{
    ...
    /// assembly that implement <see cref="IGeneratedEntity"/>.
    /// </para>
    /// </summary>
    public sealed class RoundTripInputFormatter : TextInputFormatter
    {
        ...
        {
            return type.Implements<IGeneratedEntity>();
        }
        ...
        public override async Task<InputFormatterResult> ReadRequestBodyAsync(InputFormatterContext context, Encoding encoding)
        {
            ...
            {
                return await InputFormatterResult.SuccessAsync(GeneratedEntityFactory.CreateFrom(context.ModelType, request.Body));
            }
        }
    }
}
