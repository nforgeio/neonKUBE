...
namespace TestCadence
{
    public partial class Test_Options : IClassFixture<CadenceFixture>, IDisposable
    {
        ...
        public Test_Options(CadenceFixture fixture)
        {
            ...
            if (fixture.Start(fixtureSettings, image: CadenceTestHelper.CadenceImage, keepConnection: true, keepOpen: CadenceTestHelper.KeepCadenceServerOpen) == TestFixtureStatus.Started)
            {
