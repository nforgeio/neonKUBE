...
namespace TestCadence
{
    public partial class Test_WorkflowStubManager
    {
        ...
        {
            var stub = StubManager.Create<IWorkflowEntryVoidNoArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowEntryVoidWithArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowEntryResultWithArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowMultiEntry>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowSignalNoArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowSignalWithArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowQueryVoidNoArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowQueryVoidWithArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowQueryResultWithArgs>(client);
        ...
        {
            var stub = StubManager.Create<IWorkflowMultiMethods>(client);
