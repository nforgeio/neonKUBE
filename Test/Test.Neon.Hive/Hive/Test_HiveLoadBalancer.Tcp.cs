//-----------------------------------------------------------------------------
// FILE:	    Test_HiveLoadBalancer.Tcp.cs
...
namespace TestHive
{
    ...
    {
        /// <summary>
        /// Verify that we can create an TCP load balancer rule for a 
        ...
        private async Task TestTcpRule(string testName, int proxyPort, string network, LoadBalancerManager loadBalancerManager, string serviceName = "vegomatic")
        {
