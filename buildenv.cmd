...
if exist %NF_ROOT%\NeonForge.sln goto goodPath
echo The [%NF_ROOT%\NeonForge.sln] file does not exist.  Please pass the path
...
%NF_TOOLBIN%\pathtool -dedup -system -add "%WINSDKPATH%"
