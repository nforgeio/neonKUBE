The [$/Doc/ImageSource] folder is used to organize the source files (e.g. Visio drawings) and images used to generate images that are embedded into GitHub issues or Wiki.
