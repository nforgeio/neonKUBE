...
func (reply *WorkflowInvokeReply) GetWorkflowContextID() int64 {
	return reply.WorkflowReply.GetWorkflowContextID()
}

// SetWorkflowContextID inherits docs from WorkflowReply.SetWorkflowContextID()
func (reply *WorkflowInvokeReply) SetWorkflowContextID(value int64) {
