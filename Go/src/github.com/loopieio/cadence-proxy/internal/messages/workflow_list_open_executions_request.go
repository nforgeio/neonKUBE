...
func (request *WorkflowListOpenExecutionsRequest) GetWorkflowContextID() int64 {
...
func (request *WorkflowListOpenExecutionsRequest) SetWorkflowContextID(value int64) {
