...
type (
	...
	// a WorkflowContextRequest contains a WorkflowContextID, which is a int64 property
	//
	...
	// implement.  It allows access to a WorkflowContextRequest's WorkflowContextID, a property
...
// GetWorkflowContextID gets the ContextId from a WorkflowContextRequest's properties
// map.
//
// returns int64 -> the long representing a WorkflowContextRequest's ContextId
func (request *WorkflowContextRequest) GetWorkflowContextID() int64 {
	return request.GetLongProperty("WorkflowContextId")
}

// SetWorkflowContextID sets the ContextId in a WorkflowContextRequest's properties map
//
// param value int64 -> int64 value to set as the WorkflowContextRequest's ContextId
// in its properties map
func (request *WorkflowContextRequest) SetWorkflowContextID(value int64) {
