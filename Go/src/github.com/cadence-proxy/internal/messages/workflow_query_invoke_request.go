...
func NewWorkflowQueryInvokeRequest() *WorkflowQueryInvokeRequest {
	...
	request.SetType(messagetypes.WorkflowQueryInvokeRequest)
	request.SetReplyType(messagetypes.WorkflowQueryInvokeReply)
...
// state of a workflow
func (request *WorkflowQueryInvokeRequest) GetReplayStatus() cadenceworkflows.ReplayStatus {
...
// state of a workflow
func (request *WorkflowQueryInvokeRequest) SetReplayStatus(value cadenceworkflows.ReplayStatus) {
	status := value.String()
