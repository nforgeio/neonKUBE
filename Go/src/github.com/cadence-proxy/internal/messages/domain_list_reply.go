...
//
// returns []*cadenceshared.DescribeDomainResponse -> Lists information about the
// Cadence domains.
func (reply *DomainListReply) GetDomains() []*cadenceshared.DescribeDomainResponse {
	var resp []*cadenceshared.DescribeDomainResponse
...
// lists information about the Cadence domains.
//
// param value []*cadenceshared.DescribeDomainResponse -> Lists information about the
// Cadence domains.
func (reply *DomainListReply) SetDomains(value []*cadenceshared.DescribeDomainResponse) {
