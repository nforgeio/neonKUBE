module github.com/cadence-proxy

go 1.12

require (
	github.com/Shopify/sarama v1.23.1 // indirect
	github.com/a3linux/amazon-ssm-agent v0.0.0-20160402170735-8f4b98b7fa1a
	...
	github.com/gocql/gocql v0.0.0-20190915153252-16cf9ea1b3e2 // indirect
