...
func (reply *ActivityGetLocalResultReply) GetReplayStatus() internal.ReplayStatus {
...
// state of an activity
func (reply *ActivityGetLocalResultReply) SetReplayStatus(value internal.ReplayStatus) {
	status := value.String()
