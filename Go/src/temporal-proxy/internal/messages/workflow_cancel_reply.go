...
func NewWorkflowCancelReply() *WorkflowCancelReply {
	...
	reply.SetType(internal.WorkflowCancelReply)
...
func (reply *WorkflowCancelReply) Build(e *proxyerror.TemporalError, result ...interface{}) {
