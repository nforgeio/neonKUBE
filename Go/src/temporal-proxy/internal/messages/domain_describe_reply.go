...
// pointer from a DomainDescribeReply's properties map.
//
// returns *temporalshared.DomainStatus -> status of the specified domain.
func (reply *DomainDescribeReply) GetDomainInfoStatus() *temporalshared.DomainStatus {
...
// pointer in a DomainDescribeReply's properties map
//
// param value *temporalshared.DomainStatus -> status of the specified domain.
func (reply *DomainDescribeReply) SetDomainInfoStatus(value *temporalshared.DomainStatus) {
	status := value.String()
