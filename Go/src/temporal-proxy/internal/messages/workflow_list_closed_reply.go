//-----------------------------------------------------------------------------
// FILE:		workflow_list_closed_reply.go
...
func NewWorkflowListClosedReply() *WorkflowListClosedReply {
	...
	reply.SetType(internal.WorkflowListClosedReply)
...
func (reply *WorkflowListClosedReply) Build(e *proxyerror.TemporalError, result ...interface{}) {
