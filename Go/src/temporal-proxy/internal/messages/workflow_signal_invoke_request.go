...
// state of a workflow
func (request *WorkflowSignalInvokeRequest) GetReplayStatus() internal.ReplayStatus {
...
// state of a workflow
func (request *WorkflowSignalInvokeRequest) SetReplayStatus(value internal.ReplayStatus) {
	status := value.String()
