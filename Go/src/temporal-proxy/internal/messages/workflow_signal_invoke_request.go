...
// state of a workflow
func (request *WorkflowSignalInvokeRequest) GetReplayStatus() proxytemporal.ReplayStatus {
...
// state of a workflow
func (request *WorkflowSignalInvokeRequest) SetReplayStatus(value proxytemporal.ReplayStatus) {
	status := value.String()
