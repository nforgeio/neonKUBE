...
//
// returns *ChildMap -> a temporal workflow child contexts map
...
//
// param value *ChildMap -> a temporal workflow child contexts map
func (wectx *Context) SetChildren(value *ChildMap) {
	wectx.children = value
}

// AddChild adds a new temporal context and its corresponding ContextId into
